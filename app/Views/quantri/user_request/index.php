 ...
 * @var \App\Models\FormRequestModel[] $models
 * @var \CodeIgniter\Pager\Pager $pager
 */

$this->title = 'Quản lý Danh sách Yêu cầu gọi lại';
?>
<div class="card">
                ...
                <?php foreach ($models as $model): ?>
                    <tr>
                        ...
                        <td class="row-actions">
                            <a href="<?= route_to('admin_user_request_view', $model->getPrimaryKey()) ?>"
                               class="btn btn-warning btn-just-icon">
                                <i class="material-icons">remove_red_eye</i>
                            </a>
                            <a href="<?= route_to('admin_user_request_delete', $model->getPrimaryKey()) ?>"
